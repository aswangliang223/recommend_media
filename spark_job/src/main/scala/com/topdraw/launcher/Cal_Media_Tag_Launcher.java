 ...
 */
public class Cal_Media_Tag_Launcher implements Job {
    private static Logger logger = Logger.getLogger(Cal_Media_Tag_Launcher.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            SparkAppHandle handle = new SparkLauncher(env)
                    ...
                    .setAppResource("/x/data/ai_recommend/CalMediaTag.jar")
                    .setMainClass("com.topdraw.job.Cal_Media_Tag")
                    .setMaster("yarn")
                    .setAppName("CalMediaTag_" + sdf.format(new Date()))
