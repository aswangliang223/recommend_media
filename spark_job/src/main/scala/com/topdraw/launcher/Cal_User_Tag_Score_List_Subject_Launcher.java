...
/**
 * @author wangliang
 * @date 2019-06-28-15:08
 */
public class Cal_User_Tag_Score_List_Subject_Launcher implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            SparkAppHandle handle = new SparkLauncher(env)
                    ...
                    .setAppResource("/x/data/ai_recommend/CalUserTagScoreListSubject.jar")
                    .setMainClass("com.topdraw.job.Cal_User_Tag_Score_List_Subject")
                    .setMaster("yarn")
                    .setAppName("CalUserTagScoreListSubject_"+sdf.format(new Date()))
