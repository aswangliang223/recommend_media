...
/**
 * @author wangliang
 * @date 2019-07-17-15:47
 */
public class Cla_Media_Play_One_Month_Score_Launcher implements Job {
    private static Logger logger =  Logger.getLogger(Cla_Media_Play_One_Month_Score_Launcher.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            SparkAppHandle handle = new SparkLauncher(env)
                    ...
                    .setAppResource("/x/data/ai_recommend/CalMediaScoreOfOneMonth.jar")
                    .setMainClass("com.topdraw.job.Cal_Media_Play_One_Month_Score")
                    .setMaster("yarn")
                    .setAppName("CalMediaPlayScoreOfOneMonth_" + sdf.format(new Date()))
