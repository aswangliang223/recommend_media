...
/**
 * @author wangliang
 * @date 2019-07-03-9:55
 * @Description 用户截止目前的收藏情况打分
 */
public class Cal_Media_His_Now_Collection_Launcher implements Job {
    private static Logger logger = Logger.getLogger(Cal_Media_His_Now_Collection_Launcher.class);
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            SparkAppHandle handle = new SparkLauncher(env)
                    ...
                    .setAppResource("/x/data/ai_recommend/CalHistoryCollection.jar")
                    .setMainClass("com.topdraw.job.Cal_Media_His_Now_Collection")
                    .setMaster("yarn")
                    .setAppName("CalHistoryCollection_" + sdf.format(new Date()))
