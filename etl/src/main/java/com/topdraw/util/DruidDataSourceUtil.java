...
public class DruidDataSourceUtil {
    private final static Logger logger = Logger.getLogger(DruidDataSourceUtil.class);
    //申明DataSource
    public static DataSource dataSource;
    //初始化连接池
    static {
        //加载配置文件
        InputStream is = DruidDataSourceUtil.class.getClassLoader().getResourceAsStream("druid_media_source_read_00.properties");
        //创建连接池对象
        try {
